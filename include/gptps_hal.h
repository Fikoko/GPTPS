...
/* --- declared here, implemented in later T3 increments ------------------- *
 * threads + mutex/condvar (pool), dynamic loading (add-on loader), and the OS
 * memory cap (out-of-process executor: setrlimit / cgroups / Job Objects).
 */
